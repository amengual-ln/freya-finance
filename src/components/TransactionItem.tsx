...
export const TransactionItem = ({ transaction }: props) => {
    return (
        <li className={`flex justify-between items-center p-4 my-2 rounded-lg ${transaction.type === 'income' ? 'hover:bg-green-100/30' : transaction.type === 'investment' ? 'hover:bg-yellow-100/30' : 'hover:bg-red-100/30'}`}>
